...
export default function Fruit_aloe_02() {
    return (
        <div>
            <Page_menu />
            <Fruit_sever_title />
            ...
            <div className="recipe">
                <img src={require('../images/aloe_03.png')} />
            </div>
            <div className="recipe_bottom">
                <div className="recipe_bottom_left">
                    <a
                        href="https://evape.kr/bbs/board.php?bo_table=recipe&wr_id=13439&sfl=wr_subject%7C%7Cwr_content%2C1&stx=mango&sop=and"
                        target={'_blank'}
                    >
                        <h5>출처 - 이베이프 </h5>
                    </a>

...
export default function Fruit_apple_01() {
    return (
        <div>
            <Page_menu />
            <Fruit_sever_title />
            ...
            <div className="little_img">
                <img src={require('../images/little_img_apple_01.png')} />
                <h6>Apple Cobbler</h6>
            </div>
            <div className="recipe">
                <img src={require('../images/apple_01.png')} />
            </div>
            <div className="recipe_bottom">
                <div className="recipe_bottom_left">
                    <a
                        href="https://evape.kr/bbs/board.php?bo_table=recipe&wr_id=11071&sfl=wr_subject%2C1&stx=apple&sop=and"
                        target={'_blank'}
                    >
                        <h5>출처 - 이베이프 </h5>
                    </a>

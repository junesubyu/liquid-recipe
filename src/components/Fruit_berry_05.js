...
export default function Fruit_berry_05() {
    return (
        <div>
            <Page_menu />
            <Fruit_sever_title />
            ...
            <div className="little_img">
                <img src={require('../images/little_img_berry_05.png')} />
                <h6>Berry Dragon</h6>
            </div>
            <div className="recipe">
                <img src={require('../images/berry_05.png')} />
            </div>
            <div className="recipe_bottom">
                <div className="recipe_bottom_left">
                    <a
                        href="https://evape.kr/bbs/board.php?bo_table=recipe&wr_id=11775&sfl=wr_subject%7C%7Cwr_content%2C1&stx=berry&sop=and&page=1"
                        target={'_blank'}
                    >
                        <h5>출처 - 이베이프 </h5>
                    </a>
